...
return (
  <footer className="bg-[#502424] h-full w-full z-80">
    <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-[-15] sm:mt-18 space-y-4 text-sm">
              ...
              <li>
                <a href="/user/services/body/massage_therapy" className="text-[#e0d8ad] text-xs ml-4 transition hover:opacity-75"> Massage Therapy </a>
              </li>

              <li>
                <a href="/user/services/body/scrub_and_wraps" className="text-[#e0d8ad] text-xs ml-4 transition hover:opacity-75"> Scrub and Wraps </a>
              </li>

              <li>
                <a href="/user/services/body/healing_massage" className="text-[#e0d8ad] text-xs ml-4 transition hover:opacity-75">
                  Healing Massage
                </a>
              </li>
            </ul>
      ...
      <div className="flex">
          <p className="text-sm text-[#e0d8ad]">&copy; 2025. The Mandara Spa. All rights reserved. Powered by<span><a target="_blank" rel="noreferrer" href="https://apexeldevelopment.com/?fbclid=IwZXh0bgNhZW0CMTEAAR3hqnud5A9vvZNNDy5XGnNh6dxFkM1Z6AaH9f7nZyMDcgeQCWzCJvQ8YiI_aem_Ij_lDZZcc9U_3IjhJIrNog" className="text-sm text-[#e0d8ad] ml-1 font-semibold transition-all hover:opacity-75">Apexel Development</a></span></p>
      </div>
    </div>
  </footer>
  )
